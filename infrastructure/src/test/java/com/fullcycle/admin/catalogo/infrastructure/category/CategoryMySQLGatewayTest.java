...
public class CategoryMySQLGatewayTest {
    ...
    @Test
    public void givenFollowPagination_whenCallsFindAllWithPage1_shouldReturnReturnPaginated() {
        var expectedPage = 0;
        final var expectedPerPage = 1;
        final var expectedTotal = 3;
    ...
    @Test
    public void givenPrePersistedCategoriesAndMaisAssistidasAsTerms_whenCallsFindAllAndTermsMatchsCategoryDescription_shouldReturnPaginated() {
        final var expectedPage = 0;
        final var expectedPerPage = 1;
        final var expectedTotal = 1;
